/// AI-powered analysis of liboqs release notes
///
...
class AiAnalysisResult {
  ...
  factory AiAnalysisResult.defaultResult(String newVersion) {
    return AiAnalysisResult(
      ...
      changelogEntry: '- Updated liboqs native library to $newVersion',
      modelUsed: null,
    );
  }
...
AiAnalysisResult? _parseAiResponse(String content, String model) {
  try {
    ...
    return AiAnalysisResult(
      ...
      newAlgorithms: extractField('NEW_ALGORITHMS'),
...
You are analyzing release notes for liboqs (Open Quantum Safe library).
...
- **major**: Breaking API changes, removed algorithms, struct changes
- **minor**: New algorithms, new features that don't break existing code
